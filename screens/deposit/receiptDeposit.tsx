...
const ReceiptDepositScreen = ({navigation}: Props) => {
  ...
  const depositReceiptDefaultValue: Receipts = {
    id: uuidv4(),
    services: [],
  ...
  const methods = useForm({
    defaultValues: depositReceiptDefaultValue,
    mode: 'onChange',
  });
  ...
  return (
    <>
      ...
      <KeyboardAwareScrollView style={styles.container}>
        ...
        {  editQuotation?.deposit?.firstDeposit! > 0 ? 'ใบเสร็จรับเงินส่วนที่เหลือ' :'ใบเสร็จรับเงินมัดจำ' }
