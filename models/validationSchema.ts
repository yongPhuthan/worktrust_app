...
import { InspectorEmbed } from '@prisma/client';
  ...
  export const quotationEventsEmbed : yup.ObjectSchema<IQuotationEventsEmbed> = yup.object().shape({
  ...
  export const rejectValidationSchema: yup.ObjectSchema<IRejectEmbed> = yup.object().shape({
    images: yup
      .array()
  ...
  export const reviewValidationSchema: yup.ObjectSchema<any> = yup.object().shape({
    ...
    socialProvider: yup.mixed<SocialProvider>()
    .oneOf([
  ...
  export const defaulatStandardSchema: yup.ObjectSchema<IStandardEmbed> = yup
    .object({
  ...
  export const serviceValidationSchema: yup.ObjectSchema<IServiceEmbed> =
    yup.object({
      ...
      discountType: yup
        .mixed<DiscountType>()
        .oneOf([DiscountType.PERCENT, DiscountType.THB])
  ...
  export const customerSignSchema: yup.ObjectSchema<ICustomerEmbed> = yup.object({
  ...
  export const quotationsValidationSchema: yup.ObjectSchema<IQuotations> = yup
    .object()
    .shape({
  ...
  export const submissionValidationSchema: yup.ObjectSchema<any> = yup.object().shape({
